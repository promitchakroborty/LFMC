...
plt.savefig('Failure surface LFMA.pdf')
plt.close()
...
plt.savefig('Training Data LFMA.pdf')
plt.close()
...
for idx_model in range(nmodels):
    ...
    plt.ylabel('Dimension 2')
    plt.legend()
    plt.savefig('Model ' + str(idx_model+1) + ' train LFMA.pdf')
    plt.close()
...
plt.ylabel('Dimension 2')
plt.legend()
plt.savefig('Selected Model LFMA.pdf')
plt.close()
...
plt.legend()
plt.savefig('HF vs Surrogate LFMA.pdf')
plt.close()
...
plt.savefig('Cumulative HF LFMA.pdf')
plt.close()
...
plt.xlabel('Sample Index')
plt.ylabel('Surrogate response')
plt.savefig('Surrogate LFMA.pdf')
plt.close()
...
plt.legend()
plt.savefig('Model probabilities LFMA.pdf')
plt.close()
...
plt.legend()
plt.savefig('Cumulative LF calls LFMA.pdf')
plt.close()
...
for idx_model in range(nmodels):
    ...
    plt.savefig('Noise Variance Evolution for Model ' + str(idx_model) + ' LFMA.pdf')
    plt.close()
...
plt.legend()
plt.savefig('Evolution of AIC Probabilities LFMA.pdf')
plt.close()
...
for idx_model in range(nmodels):
    ...
    plt.xlabel('Training Sample Index')
    plt.ylabel('AICc')
    plt.savefig('AICc Evolution for Model ' + str(idx_model) + ' LFMA.pdf')
    plt.close()
